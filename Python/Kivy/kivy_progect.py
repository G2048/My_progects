...
class MyApp(App):
	def build (self):
		...
		'''return Button (text="Hello!", 
			           ...
			           background_normal = '') '''
		return s #f1	         
		# size_hint Указывает процент размера кнопки относительно Layout  
		# pos Позиция кнопки
		# background_color Задает цвет кнопки
		# on_press Метод, который указывает, что делать, если нажата кнопка
